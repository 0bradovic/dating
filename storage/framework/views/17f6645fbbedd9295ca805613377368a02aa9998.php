            ...
            <div id="login-form" class="login-form">
              <!-- <form method="POST" action="<?php echo e(route('client.login.submit')); ?>">
                ...
                <div class="form-group<?php echo e($errors->has('username') ? ' has-error' : ''); ?>">
                        ...
                        <input id="email" type="text" class="form-control" name="email" placeholder="Username" value="<?php echo e(old('email')); ?>" required autofocus>
      ...
      <section class="offers-section">
        <div class="container">
          ...
          <div class="section-separator">
            <img src="<?php echo e(URL::to('/').'/images/section-separator.jpg'); ?>">
          </div>
          <div class="row-grid">
            <div class="grid-item">
              <div class="offer-img"><img src="<?php echo e(URL::to('/').'/images/anti-scam.png'); ?>"></div>
            ...
            <div class="grid-item">
              <div class="offer-img"><img src="<?php echo e(URL::to('/').'/images/support.png'); ?>"></div>
              <div class="offer-title">Support 24/7</div>
              <div class="offer-description">Lorem Ipsum is simply dummy text of the printing typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever s∂ince the 1500s, when an unknown printer took a galley </div>
            </div>
            <div class="grid-item">
              <div class="offer-img"><img src="<?php echo e(URL::to('/').'/images/matching.png'); ?>"></div>
      ...
      <section class="meet-section">
        <div class="container">
          <div class="row-grid top">
            <div class="grid-item">
              <img src="<?php echo e(URL::to('/').'/images/single-img-1.png'); ?>">
              <div class="info-wrap">
                <div class="info">
                  <span class="name">Lara<span>, <span class="age">23<span>
                </div>
                <div class="status">
                  <img class="status-icon" src="<?php echo e(URL::to('/').'/images/online-icon.png'); ?>">
                  <span class="status-name">online</span>
                </div>
              </div>
            </div>
            <div class="grid-item">
              <img src="<?php echo e(URL::to('/').'/images/single-img-2.png'); ?>">
              <div class="info-wrap">
                <div class="info">
            ...
            <div class="grid-item">
              <img src="<?php echo e(URL::to('/').'/images/single-img-3.png'); ?>">
              <div class="info-wrap">
                <div class="info">
            ...
            <img src="<?php echo e(URL::to('/').'/images/section-separator.jpg'); ?>">
                  ...
                  <div id="testimonial-slider" class="owl-carousel">
                      <div class="testimonial">
                          <div class="pic">
                              <img src="<?php echo e(URL::to('/').'/images/testimonial-img-1.png'); ?>">
                          </div>
                          <div class="info">
                      ...
                      <div class="testimonial">
                          <div class="pic">
                              <img src="<?php echo e(URL::to('/').'/images/testimonial-img-2.png'); ?>">
                          </div>
                          <div class="info">
                            <div class="info-header">
                              <h3 class="title"><span class="name">John</span>, <span class="age">46</span></h3>
      ...
      <section class="video-section">
        <div class="container">
          <div class="video-row">
            <div class="video-col">
            <video controls>
              <source src="<?php echo e(URL::to('/').'/videos/video1.mp4'); ?>" type="video/mp4">
            </video>
            </div>
        ...
        <div class="footer-row">
          <div class="footer-left">
            <div class="footer-logo">
              <a href="<?php echo e(URL::to('/')); ?>" ><img src="<?php echo e(URL::to('/').'/images/footer-logo.png'); ?>"></a>
            </div>
          </div>
          <div class="footer-right">
            ...
            <div class="footer-social">
              <a class="facebook" href="#"><img src="<?php echo e(URL::to('/').'/images/footer-fb-icon.png'); ?>"></a>
              <a class="instagram" href="#"><img src="<?php echo e(URL::to('/').'/images/footer-instagram-icon.png'); ?>"></a>
            </div>
          </div>
        </div>
...
<script type="text/javascript" src="<?php echo e(URL::to('/').'/js/custom.js'); ?>"></script>
